...
> また、ほかの利用者が**設定で「USBやSDカードを挿したとき」をオンにしていた**場合、
> **その人の環境には自動再生の候補だけが残ります**。その人に、pictkura を入れ直して
> そこをオフにしてもらうか、入れ直さないなら Windows の設定で自動再生の既定を
> 選び直してもらってください。**オンにしていなければ、何も残りません。**
>
...
**MSI と持ち歩き版はそれぞれ別のバイト列**（どちらも隔離されたことはありません）。**issue #121 を閉じずに開けてあるのはこのため**で、もし隔離されたら
**定義の版と出た時刻**をそこへ書いていただけると助かります。定義が古いままの機械では、
