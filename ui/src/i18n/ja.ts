...
export const ja = {
  ...
  shortcutGroups: [
    ...
    },
    {
      ...
      keys: [
        ...
        ["1 / 0", "1 は等倍100% ⇔ 画面に合わせるの切り替え、0 は必ず画面に合わせる"],
        ["F11", "全画面"],
        ["Esc", "閉じる"],
      ],
    },
    {
      ...
      keys: [
        ...
        ["ホイール", "拡大・縮小"],
        ["ドラッグ", "拡大中に位置を動かす"],
        ["右クリック", "開く／他のアプリで開く…／ファイルの場所を開く／お気に入りに追加／選ぶ／削除（ゴミ箱へ）"],
        ["下の帯をクリック", "前後の写真へ飛ぶ"],
      ],
    },
  ...
  // 在って開けるのに出せなかった（dev #23）。言い回しは利用者の選択（2026-09-25）
  fileNotShown: "このファイルを表示できません（ファイルが壊れているか、pictkura が読めない形式です）",
  fileNotDownloaded: "このファイルはまだダウンロードされていません（オンラインになってから開き直してください）",
   ...
   **消さない**読み直しなので、削除の数は言わない */
  drivesReturnedScanned: (added: number, changed: number) =>
    `差し込まれたドライブのフォルダを読み直しました（追加${num(added)} 変更${num(changed)}）`,
  ...
  emptyLoadFailed:
    "一覧を読み込めませんでした。「再スキャン」を押すか、アプリを開き直してください。",
